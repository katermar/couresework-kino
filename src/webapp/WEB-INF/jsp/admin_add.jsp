            ...
            <div class="modal-content">
                <div class="modal-header">
                    <div class="container-fluid">
                        <div class="row">
                            <button type="button" class="close col-md-1 pull-right" data-dismiss="modal"
                                    aria-label="Close">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" placeholder="<fmt:message key="add.director.name"/>"
                                   id="genreName" name="name"
                                   required>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="form-group">
                            <label for="filmName"><fmt:message key="add.director.name"/></label>
                            <input class="form-control" type="text" placeholder="<fmt:message key="add.director.name"/>"
                                   id="directorName" name="name" required>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    ...
                    <div class="container-fluid">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" placeholder="<fmt:message key="add.film.name"/>"
                                   id="filmName" name="name" required>
                        </div>
                        <div class="form-group">
                            <label for="year"><fmt:message key="add.film.releaseYear"/></label>
                            <input class="form-control" type="number"
                                   placeholder="<fmt:message key="add.film.releaseYear"/>"
                                   id="year" name="year" max="2018" min="1900" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="url" name="poster" id="poster"
                                   placeholder="<fmt:message key="add.film.poster"/>"
