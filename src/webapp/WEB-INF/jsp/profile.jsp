                ...
                <div class="well">
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-8">
                            ...
                            <button data-toggle="modal" ${passAllowance} data-target="#modalPasswordNew"
                ...
                <form action="/controller" method="post" class="avatar-form">
                    <div class="col-md-12 col-xs-12 well">
                        ...
                        <div class="input-group col-md-7 col-xs-7" style="float: inherit">
                            ...
                            <input class="form-control avatar-url" type="url" name="file"
                                   placeholder="<fmt:message key="profile.avatar.message"/>"
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" id="email" placeholder="<fmt:message key="profile.email"/>" name="email"
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" id="email-edit" placeholder="<fmt:message key="profile.email"/>"
                                   name="email"
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" placeholder="<fmt:message key="realName"/>" name="realname"
                                   pattern="[a-zA-Z\s\p{IsCyrillic}]" value="${sessionScope.user.realName}">
                        </div>
                        <div class="form-group">
                            <label><b><fmt:message key="main.birthday"/></b></label>
                            <input class="form-control" type="date" placeholder="<fmt:message key="main.birthday"/>" name="birthday"
...
<div class="modal fade" id="modalPasswordNew" tabindex="-1" role="dialog" aria-labelledby="modalPasswordTitle"
     aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form action="/controller" method="post">
