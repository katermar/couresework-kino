  ...
  <span onclick="document.getElementById('register').style.display='none'"
    ...
    <form class="modal-content-custom animate regform" method="post"
        ...
        <div class="container-custom">
            ...
            <input type="text" placeholder="<fmt:message key="register.username"/>" name="uname" required
                   class="uname" pattern="^[a-zA-Z]([a-zA-Z0-9_]+){4,}">

            <label><b><fmt:message key="main.password"/> </b></label>
            <input type="password" placeholder="<fmt:message key="register.password"/>" id="psw" name="psw"
                   pattern="(?=.{6,})(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9]).*" required>
            <input type="password" placeholder="<fmt:message key="register.repPassword"/>" id="psw-repeat" name="psw"
                   pattern="(?=.{6,})(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9]).*" required>
            ...
            <div class="emails-wrap">
                <div class="email-wrap">
                    <div class="email-input"><input type="email" placeholder="<fmt:message key="profile.email"/>"
                                                    name="email" required
            ...
            <input type="text" placeholder="<fmt:message key="realName"/>" name="realname" required
                   pattern="[a-zA-Z\s\p{IsCyrillic}]">

            <label><b><fmt:message key="main.birthday"/></b></label>
            <input type="date" placeholder="<fmt:message key="main.birthday"/>" name="birthday" max="2/5/2018" required>
