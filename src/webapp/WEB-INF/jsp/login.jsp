  ...
  <span onclick="document.getElementById('login').style.display='none'"
    ...
    <form class="modal-content-custom animate loginform">
        ...
        <div class="container-custom">
            ...
            <input type="text" placeholder="<fmt:message key="main.username"/>" name="uname" class="uname" required>

            <label><b><fmt:message key="main.password"/> </b></label>
            <input type="password" placeholder="<fmt:message key="main.password"/> " name="psw" required>
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="<fmt:message key="main.username"/>" name="uname" required
